...
(async () => {
  ...
  await fs.writeFile("ccu002_01-thrombocytopenia-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ccu002_01-thrombocytopenia-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
